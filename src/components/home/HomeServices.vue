...
const specialServices = [
    {
        ...
        <svg data-prefix="fas" data-icon="truck"
            class="svg-inline--fa fa-truck w-4.5 h-4.5"
    ...
    },
    {
        ...
        <svg data-prefix="fas" data-icon="shield-halved"
            class="svg-inline--fa fa-shield-halved w-4.5 h-4.5"
    ...
    },
    {
        ...
        <svg data-prefix="fas" data-icon="arrow-rotate-left"
            class="svg-inline--fa fa-arrow-rotate-left w-4.5 h-4.5"
            role="img" viewBox="0 0 512 512" aria-hidden="true">
            <path fill="currentColor"
    ...
    },
    {
        ...
        <svg data-prefix="fas" data-icon="headset"
            class="svg-inline--fa fa-headset w-4.5 h-4.5"
...
<template>
    <SpecialServices :services="specialServices" sectionClass="py-8 bg-gray-50" containerClass="container mx-auto px-4"
        gridClass="grid md:grid-cols-2 lg:grid-cols-4 gap-4"
        itemClass="flex items-center gap-4 bg-white p-4 rounded-xl shadow-sm hover:shadow-md transition-shadow duration-300" />
</template>