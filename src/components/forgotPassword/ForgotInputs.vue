    ...
    <div class="w-full">
        <div class="bg-white rounded-2xl shadow-xl p-8 lg:p-12">
            ...
            <form class="space-y-6">
                ...
                <button type="submit"
                    class="w-full cursor-pointer bg-primary-600 text-white py-3 px-4 rounded-xl hover:bg-green-700 transition-all duration-200 font-semibold text-lg shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed">Send
                    Reset Code
                </button>
                <div class="text-center">
                    <RouterLink class="inline-flex items-center gap-2 text-sm text-primary-600 hover:text-primary-700 font-medium transition-colors"
                        to="/login">
            ...
            <div class="text-center mt-8 pt-6 border-t border-gray-100">
                <p class="text-gray-600">Remember your password?
                    <RouterLink class="text-primary-600 hover:text-primary-700 font-semibold transition-colors" to="/login">
                        Sign In
                    </RouterLink>
                </p>
            </div>
