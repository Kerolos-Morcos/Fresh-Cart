        ...
        <div class="hidden lg:block relative group" ref="dropdownRef">
            <button @click="toggleDropdown"
                ...
                <svg data-prefix="far" data-icon="circle-user"
                    class="svg-inline--fa fa-circle-user w-5 text-xl text-gray-500 group-hover:text-primary-600 transition-colors"
            ...
            <div v-show="isOpen" :class="[
                'absolute right-0 top-full mt-2 w-64 bg-white border border-gray-100 rounded-2xl shadow-xl origin-top-right transition-all duration-200',
                ...
                <div class="p-4 border-b border-gray-100">
                    <div class="flex items-center gap-3">
                        <div class="w-10 h-10 rounded-full bg-primary-100 flex items-center justify-center">
                            <svg data-prefix="far" data-icon="circle-user"
                                class="svg-inline--fa fa-circle-user w-4 text-xl text-primary-600" role="img"
