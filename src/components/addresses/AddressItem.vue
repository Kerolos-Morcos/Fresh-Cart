    ...
    <div
        ...
        <div class="flex items-start justify-between gap-4">
            <div class="flex items-start gap-4 flex-1">
                <div
                    class="w-11 h-11 rounded-xl bg-primary-50 flex items-center justify-center shrink-0 group-hover:bg-primary-100 transition-colors">
                    <svg data-prefix="fas" data-icon="location-dot"
                        class="w-4 svg-inline--fa fa-location-dot text-lg text-primary-600" role="img"
            ...
            <div class="flex items-center gap-2">
                ...
                <button @click="visible = true"
                    class="cursor-pointer w-9 h-9 rounded-lg bg-gray-100 text-gray-600 hover:bg-primary-100 hover:text-primary-600 flex items-center justify-center transition-colors"
                    title="Edit address">
                    <svg data-prefix="fas" data-icon="pen" class="w-4 svg-inline--fa fa-pen text-sm" role="img"
                ...
                <button @click="deleteAddress"
                    ...
                    title="Delete address">
                    <svg data-prefix="fas" data-icon="trash" class="w-3.5 svg-inline--fa fa-trash text-sm" role="img"
