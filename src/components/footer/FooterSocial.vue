...
const socials = [
    {
        svg: `<svg data-prefix="fab" data-icon="facebook-f"
                                class="svg-inline--fa fa-facebook-f w-4.5 h-4.5" role="img" viewBox="0 0 320 512"
                                aria-hidden="true">
    ...
    {
        svg: `<svg data-prefix="fab" data-icon="twitter" class="svg-inline--fa fa-twitter w-4.5 h-4.5"
    ...
    {
        svg: ` <svg data-prefix="fab" data-icon="instagram" class="svg-inline--fa fa-instagram w-4.5 h-4.5"
    ...
    {
        svg: `<svg data-prefix="fab" data-icon="youtube" class="svg-inline--fa fa-youtube w-4.5 h-4.5"
...
<template>
    <a v-for="social in socials" :key="social.name" :href="social.href"
        class="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center text-gray-400 hover:bg-primary-600 hover:text-white transition-colors"
        v-html="social.svg">
    </a>
</template>
