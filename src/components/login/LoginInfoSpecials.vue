...
const specials = [
    {
        svg: ` <svg data-prefix="fas" data-icon="truck" class="svg-inline--fa fa-truck text-primary-600 mr-2 w-3.5 h-3.5"
    ...
    {
        svg: `<svg data-prefix="fas" data-icon="shield-halved"
                class="svg-inline--fa fa-shield-halved text-primary-600 mr-2 w-3.5 h-3.5" role="img"
    ...
    {
        svg: ` <svg data-prefix="fas" data-icon="clock" class="svg-inline--fa fa-clock text-primary-600 mr-2 w-3.5 h-3.5"
...
<template>
    <div class="flex items-center justify-center space-x-8 text-sm text-gray-500">
        <div class="flex items-center" v-for="special in specials" :key="special.text">
            <div v-html="special.svg"></div>
            <span>
                {{ special.text }}
            </span>
        </div>
