...
<template>
    <PagesHeaderComponent label="All Categories" description="Browse our wide range of product categories">
        <template #icon>
            <svg data-prefix="fas" data-icon="layer-group" class="svg-inline--fa fa-layer-group text-3xl" role="img"
    ...
    <ComponentLoader v-if="isLoading" :title="'Categories'" bgColor="bg-primary-50" iconColor="text-primary-600" />
